            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(RestPasswordActivity.this, "You have answer security questions successfully. ", Toast.LENGTH_SHORT).show();
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.exists()){
                        ...
                        Toast.makeText(RestPasswordActivity.this, "This Phone number not exist.", Toast.LENGTH_SHORT).show();
                    }
